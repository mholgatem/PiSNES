...
int joyaxis_LR_1, joyaxis_UD_1,joyaxis_LR_2, joyaxis_UD_2;
...
void S9xInitInputDevices ()
{
	...
	sfc_key[A_2] = get_integer_conf("Keyboard", "A_2", RPI_KEY_A_2);
	sfc_key[B_2] = get_integer_conf("Keyboard", "B_2", RPI_KEY_B_2);
	sfc_key[X_2] = get_integer_conf("Keyboard", "X_2", RPI_KEY_X_2);
	sfc_key[Y_2] = get_integer_conf("Keyboard", "Y_2", RPI_KEY_Y_2);
	sfc_key[L_2] = get_integer_conf("Keyboard", "L_2", RPI_KEY_L_2);
	sfc_key[R_2] = get_integer_conf("Keyboard", "R_2", RPI_KEY_R_2);
	sfc_key[START_2] = get_integer_conf("Keyboard", "START_2", RPI_KEY_START_2);
	sfc_key[SELECT_2] = get_integer_conf("Keyboard", "SELECT_2", RPI_KEY_SELECT_2);
	sfc_key[LEFT_2] = get_integer_conf("Keyboard", "LEFT_2", RPI_KEY_LEFT_2);
	sfc_key[RIGHT_2] = get_integer_conf("Keyboard", "RIGHT_2", RPI_KEY_RIGHT_2);
	sfc_key[UP_2] = get_integer_conf("Keyboard", "UP_2", RPI_KEY_UP_2);
	sfc_key[DOWN_2] = get_integer_conf("Keyboard", "DOWN_2", RPI_KEY_DOWN_2);

	//Configure joysticks from config file or defaults
	sfc_joy[A_1] = get_integer_conf("Joystick", "A_1", RPI_JOY_A_1);
	sfc_joy[B_1] = get_integer_conf("Joystick", "B_1", RPI_JOY_B_1);
	sfc_joy[X_1] = get_integer_conf("Joystick", "X_1", RPI_JOY_X_1);
	sfc_joy[Y_1] = get_integer_conf("Joystick", "Y_1", RPI_JOY_Y_1);
	sfc_joy[L_1] = get_integer_conf("Joystick", "L_1", RPI_JOY_L_1);
	sfc_joy[R_1] = get_integer_conf("Joystick", "R_1", RPI_JOY_R_1);
	sfc_joy[START_1] = get_integer_conf("Joystick", "START_1", RPI_JOY_START_1);
	sfc_joy[SELECT_1] = get_integer_conf("Joystick", "SELECT_1", RPI_JOY_SELECT_1);
	...
	sfc_joy[A_2] = get_integer_conf("Joystick", "A_2", RPI_JOY_A_2);
	sfc_joy[B_2] = get_integer_conf("Joystick", "B_2", RPI_JOY_B_2);
	sfc_joy[X_2] = get_integer_conf("Joystick", "X_2", RPI_JOY_X_2);
	sfc_joy[Y_2] = get_integer_conf("Joystick", "Y_2", RPI_JOY_Y_2);
	sfc_joy[L_2] = get_integer_conf("Joystick", "L_2", RPI_JOY_L_2);
	sfc_joy[R_2] = get_integer_conf("Joystick", "R_2", RPI_JOY_R_2);
	sfc_joy[START_2] = get_integer_conf("Joystick", "START_2", RPI_JOY_START_2);
	sfc_joy[SELECT_2] = get_integer_conf("Joystick", "SELECT_2", RPI_JOY_SELECT_2);
	//Read joystick axis to use, default to 2 & 3
	joyaxis_LR_2 = get_integer_conf("Joystick", "JA_LR_2", 2);
	joyaxis_UD_2 = get_integer_conf("Joystick", "JA_UD_2", 3);
...
void S9xProcessEvents (bool8_32 block)
{
	...
	while(SDL_PollEvent(&event)) {
        ...
        case SDL_JOYAXISMOTION:
			if(event.jaxis.axis == joyaxis_LR_1) {
				if(event.jaxis.value > -10000 && event.jaxis.value < 10000)
					joy_axes[event.jbutton.which][joyaxis_LR_1] = CENTER;
				else if(event.jaxis.value > 10000)
					joy_axes[event.jbutton.which][joyaxis_LR_1] = RIGHT;
				else
					joy_axes[event.jbutton.which][joyaxis_LR_1] = LEFT;
			}
			if(event.jaxis.axis == joyaxis_UD_1) {
				if(event.jaxis.value > -10000 && event.jaxis.value < 10000)
					joy_axes[event.jbutton.which][joyaxis_UD_1] = CENTER;
				else if(event.jaxis.value > 10000)
					joy_axes[event.jbutton.which][joyaxis_UD_1] = DOWN;
				else
					joy_axes[event.jbutton.which][joyaxis_UD_1] = UP;
			}
